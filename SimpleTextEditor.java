// Here i have worked on creating an simple text editor for the Document Management System for providing with rich text elements and 
// and for reading writing and saving the files ..... 
package application;
import java.io.*;
import java.awt.*;
import javax.swing.*;
...
public class SimpleTextEditor implements ActionListener
{
	...
	txtarea.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("control U"), "Underline");
	 ...
	 {
		 JFileChooser j = new JFileChooser("C:/Downloads/5436157.txt"); 
